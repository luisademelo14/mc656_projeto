...
const Footer = () => {
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 h-20 w-full bg-white shadow-lg z-50"> {/* Footer fixo */}
      <div className="flex w-full h-full"> {/* Full width container for buttons */}
        {/* Botão 1 */}
